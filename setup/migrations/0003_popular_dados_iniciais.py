...
def popular_dados(apps, schema_editor):
    ...
    p27 = Pergunta.objects.create(assunto=assunto_c_c, texto='Como se escreve a condição "se x é maior ou igual a y" em C', explicacao="O operador lógico 'OU' em C é representado por duas barras verticais ||. Ele retorna verdadeiro se pelo menos uma das condições for verdadeira.")

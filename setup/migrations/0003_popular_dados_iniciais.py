...
def popular_dados(apps, schema_editor):
    ...
    # ====================================================================
    assunto_py_c_nome = 'Estruturas Condicionais'
    ...
    PerguntaDificuldade.objects.create(pergunta=p14, dificuldade=medio)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        # Coloque aqui o nome da migração anterior que criou os novos modelos
        # Exemplo: ('setup', '0002_dificuldade_perguntadificuldade'),
    ]

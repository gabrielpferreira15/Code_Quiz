...
urlpatterns = [
    ...
    path('selecionar-ranking/', views.selecionar_ranking, name='selecionar_ranking'),
    path('ranking/<int:assunto_id>/<int:dificuldade_id>/', views.ranking_quiz, name='ranking_quiz'),
]